...
-- Database: `festival`
--
CREATE DATABASE IF NOT EXISTS `cmetrot_festival` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `cmetrot_festival`;
...
CREATE TABLE `Lieu` (
  ...
  `adr` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `Representation` (
  ...
  `id_groupe` varchar(4) COLLATE utf8_bin DEFAULT NULL,
...
(1, 'Metrot', 'Corentin', 'cmetrot@la-joliverie.com', 'cmetrot', '50fa5e71642c7863c027de8976d0fdbb53964d10'),
(2, 'BTS', 'SIO', 'btssio@la-joliverie.com', 'btssio', 'e23598039a74d88417afc1e78f3f94be4edc9d6f');
...
GRANT USAGE ON *.* TO 'cmetrot_festival'@'%' IDENTIFIED BY PASSWORD '*14E65567ABDB5135D0CFD9A70B3032C179A49EE7';

GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, INDEX, ALTER, CREATE TEMPORARY TABLES, EXECUTE, CREATE VIEW, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE, EVENT, TRIGGER ON `cmetrot\_festivalB`.* TO 'cmetrot_festival'@'%';

GRANT ALL PRIVILEGES ON `cmetrot_festival`.* TO 'cmetrot_festival'@'%';